...
const ViewInvoiceScreen = ({ navigation }) => {
		...
		Alert.alert(
			...
			[
				...
				},
				{
					...
					onPress: async () => {
						// delete from client
						let clientListObject = await AsyncStorage.getItem(
							'clients'
						)
						...
						let invoiceListObject = await AsyncStorage.getItem(
							'invoices'
						)
